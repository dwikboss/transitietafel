    ...
    <div class="page dashboard">
        <div class="banner">
            ...
            <div class="free-question">
                ...
                <InputField borderStyle="none" placeholder="Type jouw vraag..." @submit="" />
            </div>
        </div>
                        ...
                        <div class="articles">
                            <div class="article" v-for="(article, index) in articles" :key="index">
                                <div class="article-heading">
                                    <p class="article-title">{{ article.title }}</p><span>•</span><a :href=article.url
                                        class="article-link">Bronvermelding</a>
                                </div>
